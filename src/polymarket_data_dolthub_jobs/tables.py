...
from polymarket_data_dolthub_jobs.step_2d_bronze_gamma_tags import (
    BronzeGammaEventsTagLinkSchema,
    BronzeGammaTagSchema,
)
...
TABLES_TO_SCHEMAS = {
    ...
    "bronze_gamma_tags": BronzeGammaTagSchema,
    "bronze_gamma_event_series_link": BronzeGammaEventsSeriesLinkSchema,
    "bronze_gamma_event_tag_link": BronzeGammaEventsTagLinkSchema,
